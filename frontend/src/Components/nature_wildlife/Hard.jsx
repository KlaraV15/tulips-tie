...
const mockQuestions = [
  ...
  },
  {
    id: 2,
    country: "Croatia",
    question: "Which endemic fish species lives in Plitvice Lakes?",
    options: ["Brown trout", "Carp", "Catfish", "Zander"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 3,
    country: "Netherlands",
    question: "Which UNESCO site in the Netherlands is famous for bird migration?",
    options: ["Wadden Sea", "Kinderdijk", "Schokland", "Amsterdam Canal Ring"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
  ...
  },
  {
    id: 7,
    country: "Netherlands",
    question: "Which type of unique ecosystem makes the Wadden Sea special?",
    options: ["Intertidal zone", "Coral reef", "Mangrove", "Rainforest"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
  ...
  },
  {
    id: 10,
    country: "Croatia",
    question: "Which karst phenomenon is typical in Croatian landscapes?",
    options: ["Sinkholes", "Volcanoes", "Glaciers", "Sand dunes"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
]
