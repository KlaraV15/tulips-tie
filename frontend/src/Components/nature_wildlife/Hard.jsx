...
const mockQuestions = [
  {
    id: 1,
    country: "Croatia",
    question: "Which large carnivore still lives in the forests of Croatia?",
    options: ["Brown bear", "Lion", "Wolf", "Lynx"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 2,
    country: "Netherlands",
    question: "Which rare wild cat was reintroduced in the Netherlands?",
    options: ["European wildcat", "Lynx", "Cheetah", "Serval"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 3,
    country: "Croatia",
    question: "Which island in Croatia is known as a breeding site for the griffon vulture?",
  ...
  },
  {
    id: 4,
    country: "Netherlands",
    question: "Which large mammals were reintroduced in the Oostvaardersplassen reserve?",
    options: ["Konik horses", "Bison", "Elk", "Red deer"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 5,
    country: "Croatia",
    question: "Which Croatian national park is a UNESCO World Heritage site due to its unique lakes and waterfalls?",
    options: ["Plitvice Lakes", "Krka", "Risnjak", "Paklenica"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 6,
    country: "Netherlands",
    question: "Which sea mammal is protected in the Wadden Sea?",
    options: ["Seal", "Dolphin", "Walrus", "Manatee"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 7,
    country: "Croatia",
    question: "Which rare lynx species lives in Croatian mountains?",
    options: ["Eurasian lynx", "Iberian lynx", "Canadian lynx", "Caracal"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 8,
    country: "Netherlands",
    question: "Which large fish species was successfully reintroduced in Dutch rivers?",
    options: ["Sturgeon", "Shark", "Salmon", "Catfish"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 9,
    country: "Croatia",
    question: "Which national park is known for its karst rivers and caves?",
    options: ["Paklenica", "Krka", "Risnjak", "Kornati"],
    correctAnswer: 2,
    difficulty: "Hard",
  },
  {
    id: 10,
    country: "Netherlands",
    question: "Which rare bird has made a comeback in Dutch wetlands thanks to protection?",
    options: ["White-tailed eagle", "Flamingo", "Golden eagle", "Buzzard"],
    correctAnswer: 0,
    difficulty: "Hard",
  }
]
