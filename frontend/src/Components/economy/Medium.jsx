...
const mockQuestions = [
  ...
  },
  {
    id: 4,
    country: "Croatia",
    question: "Which Croatian port city is a key hub for shipbuilding?",
    options: ["Rijeka", "Dubrovnik", "Zadar", "Split"],
    correctAnswer: 3,
    difficulty: "Medium",
  },
  {
  ...
  },
  {
    id: 8,
    country: "Croatia",
    question: "Croatia is famous for exporting which type of stone used in construction?",
    options: ["Limestone", "Marble", "Granite", "Sandstone"],
    correctAnswer: 0,
    difficulty: "Medium",
  },
  {
          ...
          <Card className="max-w-2xl w-full bg-white/90 backdrop-blur-sm border-2 border-yellow-200 shadow-2xl rounded-2xl">
            <CardHeader className="text-center p-8">
              ...
              <CardDescription className="text-lg text-gray-600 font-medium">
                Here are your results from the Medium Quiz
              </CardDescription>
            </CardHeader>
