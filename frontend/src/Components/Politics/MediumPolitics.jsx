    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-xl font-bold">Get ready for a political challenge! ⚡</p>
        </div>
      </div>
    )
  }
            ...
            <CardContent className="space-y-6 p-8">
              ...
              <div className="text-center space-y-4">
                <p className="text-gray-700 text-lg font-medium bg-white/50 p-4 rounded-xl border border-gray-200">
                  {score >= 120
                    ? "🎉 Outstanding! You're a true politics master!"
                    : score >= 90
                      ? "👍 Excellent work! You know these political systems inside out!"
                      : score >= 60
                        ? "💪 Good job! Solid knowledge of Croatian and Dutch politics!"
