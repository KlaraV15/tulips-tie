    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-300 via-red-300 to-red-300 overflow-x-hidden">
      ...
      <section className="container mx-auto px-3 sm:px-4 py-8 sm:py-16">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <Badge className="mb-4 sm:mb-6 bg-red-100 text-red-700 border-red-200 text-xs sm:text-sm font-bold py-1 sm:py-2 px-2 sm:px-4 animate-bounce whitespace-nowrap overflow-hidden">
      ...
      <section className="container mx-auto px-3 sm:px-4 py-12 sm:py-20">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black mb-3 sm:mb-4 bg-gradient-to-r from-red-600 to-blue-600 bg-clip-text text-transparent">
            Quiz Features
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <Card className="bg-white border-2 border-red-200 hover:border-red-400 transition-all hover:shadow-xl sm:hover:shadow-2xl hover:scale-105 cursor-pointer">
            <CardHeader className="text-center p-4 sm:p-6">
              ...
              <CardTitle className="text-gray-800 text-lg sm:text-xl">❤️ 3 Lives System</CardTitle>
          ...
          <Card className="bg-white border-2 border-yellow-200 hover:border-yellow-400 transition-all hover:shadow-xl sm:hover:shadow-2xl hover:scale-105 cursor-pointer">
            <CardHeader className="text-center p-4 sm:p-6">
              ...
              <CardTitle className="text-gray-800 text-lg sm:text-xl">⭐ 10 Points Each</CardTitle>
              <CardDescription className="text-gray-600 font-medium text-sm sm:text-base">
          ...
          <Card className="bg-white border-2 border-purple-200 hover:border-purple-400 transition-all hover:shadow-xl sm:hover:shadow-2xl hover:scale-105 cursor-pointer">
            <CardHeader className="text-center p-4 sm:p-6">
              ...
              <CardTitle className="text-gray-800 text-lg sm:text-xl">🏆 Global Ranking</CardTitle>
              <CardDescription className="text-gray-600 font-medium text-sm sm:text-base">
          ...
          <Card className="bg-white border-2 border-blue-200 hover:border-blue-400 transition-all hover:shadow-xl sm:hover:shadow-2xl hover:scale-105 cursor-pointer">
            <CardHeader className="text-center p-4 sm:p-6">
              ...
              <CardTitle className="text-gray-800 text-lg sm:text-xl">🧠 10 Random Q's</CardTitle>
              <CardDescription className="text-gray-600 font-medium text-sm sm:text-base">
          ...
          <Card className="bg-white border-2 border-orange-200 hover:border-orange-400 transition-all hover:shadow-xl sm:hover:shadow-2xl hover:scale-105 cursor-pointer">
            <CardHeader className="text-center p-4 sm:p-6">
              ...
              <CardTitle className="text-gray-800 text-lg sm:text-xl">⏱️ Quick Rounds</CardTitle>
              <CardDescription className="text-gray-600 font-medium text-sm sm:text-base">
      ...
      {/* Game Rules - Fixed container */}
      <section className="container mx-auto px-3 sm:px-4 py-12 sm:py-20 bg-gradient-to-r from-red-50 to-blue-50 rounded-xl sm:rounded-3xl border-2 border-white shadow-xl relative overflow-hidden">
        {/* Floating decorative elements */}
        <div className="absolute top-4 sm:top-10 left-4 sm:left-10 w-12 h-12 sm:w-20 sm:h-20 bg-yellow-300 rounded-full opacity-20 animate-bounce"></div>
        <div className="absolute bottom-8 sm:bottom-16 right-8 sm:right-20 w-10 h-10 sm:w-16 sm:h-16 bg-green-300 rounded-full opacity-20 animate-pulse"></div>
        <div className="absolute top-16 sm:top-32 right-16 sm:right-32 w-8 h-8 sm:w-12 sm:h-12 bg-purple-300 rounded-full opacity-20 animate-ping"></div>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            {/* Game Rules Card */}
            <Card className="bg-white border-2 border-red-200 shadow-lg hover:shadow-xl sm:hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardHeader className="bg-gradient-to-r from-red-500 to-red-600 text-white rounded-t-lg relative p-4 sm:p-6">
                {/* Animated heart icon */}
                ...
                {[
                  ...
                  <div key={index} className="flex items-start space-x-2 sm:space-x-3 group hover:bg-red-50 p-2 rounded-lg transition-all duration-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 mt-1">{rule.icon}</p>
                    </div>
                  </div>
                ))}
              </CardContent>
            ...
            {/* Scoring System Card */}
            <Card className="bg-white border-2 border-blue-200 shadow-lg hover:shadow-xl sm:hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-t-lg relative p-4 sm:p-6">
                {/* Animated trophy icon */}
                <div className="absolute -top-4 sm:-top-6 left-1/2 transform -translate-x-1/2">
                  <div className="w-8 h-8 sm:w-12 sm:h-12 bg-blue-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-3 sm:h-4 bg-gradient-to-r from-transparent via-red-200 to-transparent opacity-50"></div>
      </section>
