...
const mockQuestions = [
  {
    id: 1,
    country: "Netherlands",
    question: "Which Dutch city hosts the world’s largest flower auction?",
    options: ["Aalsmeer", "Rotterdam", "The Hague", "Utrecht"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 2,
    country: "Croatia",
    question: "Which dog breed is originally from Croatia?",
    options: ["Dalmatian", "Bulldog", "Beagle", "Chow Chow"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 3,
    country: "Netherlands",
    question: "What traditional Dutch shoe is made of wood?",
    options: ["Clogs", "Sandals", "Boots", "Slippers"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 4,
    country: "Croatia",
    question: "Which famous inventor of the alternating current (AC) was born in Croatia?",
  ...
  },
  {
    id: 5,
    country: "Netherlands",
    question: "Which sweet Dutch treat is made of two thin waffles with syrup inside?",
    options: ["Stroopwafel", "Poffertjes", "Speculaas", "Ontbijtkoek"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 6,
    country: "Croatia",
    question: "Which ancient Roman emperor built a palace in Split, Croatia?",
    options: ["Diocletian", "Julius Caesar", "Augustus", "Nero"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 7,
    country: "Netherlands",
    question: "Which famous painter cut off part of his ear in the Netherlands?",
    options: ["Vincent van Gogh", "Rembrandt", "Vermeer", "Mondrian"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 8,
    country: "Croatia",
    question: "Which Croatian city invented the necktie (cravat)?",
  ...
  },
  {
    id: 9,
    country: "Netherlands",
    question: "Which Dutch scientist discovered microbes using a microscope?",
    options: ["Antonie van Leeuwenhoek", "Isaac Newton", "Louis Pasteur", "Galileo Galilei"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
    id: 10,
    country: "Croatia",
    question: "Which UNESCO-listed city wall is among the longest in Europe?",
    options: ["Ston Walls", "Dubrovnik Walls", "Zagreb Walls", "Split Walls"],
    correctAnswer: 0,
    difficulty: "Hard",
  }
]
