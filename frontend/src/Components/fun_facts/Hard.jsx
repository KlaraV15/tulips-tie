...
const mockQuestions = [
  ...
  },
  {
    id: 4,
    country: "Netherlands",
    question: "What is the name of the Dutch national anthem, one of the oldest in the world?",
    options: ["Wilhelmus", "Het Lied", "Koningslied", "Vrijheidslied"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
  {
  ...
  },
  {
    id: 9,
    country: "Croatia",
    question: "Which rare animal is a symbol of Croatia's Velebit mountains?",
    options: ["Eurasian lynx", "Balkan chamois", "Griffon vulture", "Brown bear"],
    correctAnswer: 1,
    difficulty: "Hard",
  },
  {
    id: 10,
    country: "Netherlands",
    question: "Which Dutch scientist is called the 'father of microbiology'?",
    options: ["Antoni van Leeuwenhoek", "Einstein", "Bohr", "Galilei"],
    correctAnswer: 0,
    difficulty: "Hard",
  },
]
