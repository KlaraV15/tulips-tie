...
const mockQuestions = [
    {
      ...
      options: ["Ivo Sanader", "Franjo Tuđman", "Stjepan Radić", "Ante Starčević"],
      correctAnswer: 1,
      difficulty: "Easy",
    },
    {
    ...
    },
    {
      id: 3,
      country: "Croatia",
      question: "When did Croatia declare independence from Yugoslavia?",
      options: ["1990", "1992", "1989", "1991"],
      correctAnswer: 3,
      difficulty: "Easy",
    },
    {
      id: 4,
      country: "Netherlands",
      question: "Who led the Dutch revolt against Spain during the Eighty Years' War?",
      options: ["Maurice of Nassau", "Rembrandt", "Philip II", "William of Orange"],
      correctAnswer: 3,
      difficulty: "Easy",
    },
    {
      id: 5,
      country: "Croatia",
      question: "Which medieval Croatian king was the first crowned king?",
      options: ["Petar Krešimir IV", "Zvonimir", "Trpimir", "Tomislav"],
      correctAnswer: 3,
      difficulty: "Easy",
    },
    {
      id: 6,
      country: "Netherlands",
      question: "Which Dutch painter is famous for 'The Night Watch'?",
      options: ["Vermeer", "Frans Hals", "Rembrandt", "Van Gogh"],
      correctAnswer: 2,
      difficulty: "Easy",
    },
    {
      id: 7,
      country: "Croatia",
      question: "Which city was the capital of the Republic of Ragusa?",
      options: ["Dubrovnik", "Zadar", "Split", "Šibenik"],
      correctAnswer: 0,
      difficulty: "Easy",
    },
    {
      ...
      options: ["Sunflower", "Tulip", "Lily", "Rose"],
      correctAnswer: 1,
      difficulty: "Easy",
    },
    {
      id: 9,
      country: "Croatia",
      question: "Which war took place between 1991 and 1995 in Croatia?",
      options: ["World War II", "Balkan Wars", "Napoleonic Wars", "Croatian War of Independence"],
      correctAnswer: 3,
      difficulty: "Easy",
    },
    {
      id: 10,
      country: "Netherlands",
      question: "Which city was home to Anne Frank during World War II?",
      options: ["Utrecht", "Amsterdam", "Rotterdam", "The Hague"],
      correctAnswer: 1,
      difficulty: "Easy",
    }
]  

export default function EasyHistory() {
            ...
            <CardContent className="space-y-6 p-8">
              ...
              <div className="text-center space-y-4">
                <p className="text-gray-700 text-lg font-medium bg-white/50 p-4 rounded-xl border border-gray-200">
                  {score >= 80
                    ? "🎉 Excellent work! You're a history expert!"
                    : score >= 60
                      ? "👍 Good job! You know your historical facts well."
                      : score >= 40
