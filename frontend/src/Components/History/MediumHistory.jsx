...
const mockQuestions = [
  {
    id: 1,
    country: "Croatia",
    question: "Who was crowned the first king of the united Croatian kingdom in 925?",
    options: ["Tomislav", "Zvonimir", "Petar Krešimir IV", "Stjepan Držislav"],
    correctAnswer: 0,
    difficulty: "Medium",
  },
  {
    id: 2,
    country: "Netherlands",
    question: "In which year did the Netherlands become a founding member of NATO?",
    options: ["1947", "1945", "1949", "1952"],
    correctAnswer: 2,
    difficulty: "Medium",
  },
  {
    id: 3,
    country: "Croatia",
    question: "Which Croatian city was the capital of the Kingdom of Dalmatia during the Habsburg Monarchy?",
    options: ["Split", "Dubrovnik", "Šibenik", "Zadar"],
    correctAnswer: 3,
    difficulty: "Medium",
  },
  {
    id: 4,
    country: "Netherlands",
    question: "Which Dutch colony was sold to the English in 1667 and later became New York?",
    options: ["Curacao", "New Amsterdam", "Suriname", "Aruba"],
    correctAnswer: 1,
    difficulty: "Medium",
  },
  {
    id: 5,
    country: "Croatia",
    question: "Which Croatian scientist and diplomat calculated the speed of light in the 18th century?",
    options: ["Nikola Tesla", "Ivan Gundulić", "Rudjer Bošković", "Stjepan Radić"],
    correctAnswer: 2,
    difficulty: "Medium",
  },
  {
    id: 6,
    country: "Netherlands",
    question: "Who was the famous Dutch leader assassinated in 1584 for leading the revolt against Spain?",
    options: ["William of Orange", "Rembrandt", "Frans Hals", "Erasmus"],
    correctAnswer: 0,
    difficulty: "Medium",
  },
  {
    id: 7,
    country: "Croatia",
    question: "The Republic of Ragusa is the historic name of which Croatian city?",
  ...
  },
  {
    id: 8,
    country: "Netherlands",
    question: "Which war between 1672–1678 is known in Dutch history as the 'Disaster Year' (Rampjaar)?",
    options: ["Franco-Dutch War", "War of Spanish Succession", "Anglo-Dutch Wars", "Eighty Years' War"],
    correctAnswer: 0,
    difficulty: "Medium",
  },
  {
    id: 9,
    country: "Croatia",
    question: "Which Croatian king was known as 'the Great' and ruled in the 11th century?",
    options: ["Tomislav", "Zvonimir", "Stjepan Držislav", "Petar Krešimir IV"],
    correctAnswer: 3,
    difficulty: "Medium",
  },
  {
    id: 10,
    country: "Netherlands",
    question: "Which treaty in 1648 recognized the independence of the Dutch Republic from Spain?",
    options: ["Treaty of Utrecht", "Treaty of Westphalia", "Treaty of Paris", "Treaty of The Hague"],
    correctAnswer: 1,
    difficulty: "Medium",
  }
]

export default function MediumHistory() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-xl font-bold">Get ready for a historical challenge! ⚡</p>
        </div>
      </div>
    )
  }
            ...
            <CardContent className="space-y-6 p-8">
              ...
              <div className="text-center space-y-4">
                <p className="text-gray-700 text-lg font-medium bg-white/50 p-4 rounded-xl border border-gray-200">
                  {score >= 120
                    ? "🎉 Outstanding! You're a true history master!"
                    : score >= 90
                      ? "👍 Excellent work! You know these historical events inside out!"
                      : score >= 60
                        ? "💪 Good job! Solid knowledge of Croatian and Dutch history!"
