...
const mockQuestions = [
  {
    id: 1,
    country: "Croatia",
    question: "Which city in Croatia is famous for the medieval Walls of Dubrovnik?",
    options: ["Split", "Zadar", "Pula", "Dubrovnik"],
    correctAnswer: 3,
    difficulty: "Easy",
  },
  {
    id: 2,
    country: "Netherlands",
    question: "Which painter from the Netherlands is famous for the artwork 'The Starry Night'?",
    options: ["Rembrandt", "Johannes Vermeer", "Vincent van Gogh", "Hieronymus Bosch"],
    correctAnswer: 2,
    difficulty: "Easy",
  },
  {
    id: 3,
    country: "Croatia",
    question: "Which traditional Croatian dance is recognized by UNESCO as intangible heritage?",
    options: ["Polka", "Kolo", "Lindjo", "Sirtaki"],
    correctAnswer: 1,
    difficulty: "Easy",
  },
  {
  ...
  },
  {
    id: 5,
    country: "Croatia",
    question: "The city of Split was built around the palace of which Roman emperor?",
    options: ["Nero", "Augustus", "Diocletian", "Marcus Aurelius"],
    correctAnswer: 2,
    difficulty: "Easy",
  },
  {
    id: 6,
    country: "Netherlands",
    question: "What is the name of the Dutch national museum in Amsterdam?",
    options: ["Van Gogh Museum", "Rijksmuseum", "Mauritshuis", "Stedelijk Museum"],
    correctAnswer: 1,
    difficulty: "Easy",
  },
  {
    id: 7,
    country: "Croatia",
    question: "Which Croatian festival is world-famous for electronic music on the Adriatic coast?",
    options: ["Exit Festival", "Dimensions Festival", "InMusic", "Ultra Europe"],
    correctAnswer: 3,
    difficulty: "Easy",
  },
  {
    id: 8,
    country: "Netherlands",
    question: "Which flowers are a cultural symbol of the Netherlands?",
    options: ["Roses", "Lilies", "Tulips", "Sunflowers"],
    correctAnswer: 2,
    difficulty: "Easy",
  },
  {
    id: 9,
    country: "Croatia",
    question: "Which Croatian city is known for the Arena, one of the best-preserved Roman amphitheaters?",
    options: ["Pula", "Zadar", "Osijek", "Rijeka"],
    correctAnswer: 0,
    difficulty: "Easy",
  },
  {
    id: 10,
    country: "Netherlands",
    question: "Which Dutch artist is famous for geometric paintings with primary colors and straight lines?",
    options: ["Rembrandt", "Mondrian", "Bosch", "Escher"],
    correctAnswer: 1,
    difficulty: "Easy",
  }
]

export default function EasyCulture() {
            ...
            <CardContent className="space-y-6 p-8">
              ...
              <div className="text-center space-y-4">
                <p className="text-gray-700 text-lg font-medium bg-white/50 p-4 rounded-xl border border-gray-200">
                  {score >= 80
                    ? "🎉 Excellent work! You're a culture expert!"
                    : score >= 60
                      ? "👍 Good job! You know your cultural heritage well."
                      : score >= 40
