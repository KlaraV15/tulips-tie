    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-xl font-bold">Brace yourself for the ultimate cultural challenge! 🔥</p>
        </div>
      </div>
    )
  }
            ...
            <CardContent className="space-y-6 p-8">
              ...
              <div className="text-center space-y-4">
                <p className="text-gray-700 text-lg font-medium bg-white/50 p-4 rounded-xl border border-gray-200">
                  {score >= 160
                    ? "🏆 Legendary! You're a cultural expert!"
                    : score >= 120
                      ? "🎯 Incredible! You've mastered cultural knowledge!"
                      : score >= 80
                        ? "💪 Impressive! You handled the cultural challenge well!"
                        : "🌟 Tough cultural questions! Keep learning and try again!"}
                </p>
