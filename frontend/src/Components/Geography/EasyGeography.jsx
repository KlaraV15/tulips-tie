...
const mockQuestions = [
  {
    id: 1,
    country: "Croatia",
    question: "Croatia shares a land border with which of these countries?",
    options: ["Spain", "Germany", "Germany", "Hungary"],
    correctAnswer: 3,
    difficulty: "Easy",
  },
  {
    id: 2,
    country: "Netherlands",
    question: "What is the seat of government in the Netherlands, even though it is not the capital?",
  ...
  },
  {
    id: 3,
    country: "Croatia",
    question: "Which famous Roman palace is located in the Croatian city of Split?",
    options: ["Hadrian’s Villa", "Colosseum", "Diocletian’s Palace", "Forum"],
    correctAnswer: 2,
    difficulty: "Easy",
  },
  {
    id: 4,
    country: "Netherlands",
    question: "Which Dutch city is famous for its international port, one of the largest in Europe?",
    options: ["Rotterdam", "Maastricht", "Groningen", "Haarlem"],
    correctAnswer: 0,
    difficulty: "Easy",
  },
  {
    id: 5,
    country: "Croatia",
    question: "Which large peninsula in the northern Adriatic belongs mostly to Croatia?",
    options: ["Peloponnese", "Istrian Peninsula", "Iberian Peninsula", "Balkan Peninsula"],
    correctAnswer: 1,
    difficulty: "Easy",
  },
  {
    id: 6,
    country: "Netherlands",
    question: "The Netherlands shares a border with which two countries?",
    options: ["Germany and Belgium", "France and Switzerland", "Denmark and Poland", "Luxembourg and Austria"],
    correctAnswer: 0,
    difficulty: "Easy",
  },
  {
    id: 7,
    country: "Croatia",
    question: "Which Croatian island is known for lavender fields?",
  ...
  },
  {
    id: 8,
    country: "Netherlands",
    question: "The Dutch province of Friesland is known for its lakes and which officially recognized second language?",
    options: ["German", "English", "Danish", "Frisian"],
    correctAnswer: 3,
    difficulty: "Easy",
  },
  {
    id: 9,
    country: "Croatia",
    question: "Which mountain range runs along Croatia’s Adriatic coast?",
  ...
  },
  {
    id: 10,
    country: "Netherlands",
    question: "The Zuiderzee project created new land for the Netherlands. What is this reclaimed land called?",
    options: ["Fjords", "Polders", "Marshes", "Plateaus"],
    correctAnswer: 1,
    difficulty: "Easy",
  }
]

export default function EasyGeography() {
