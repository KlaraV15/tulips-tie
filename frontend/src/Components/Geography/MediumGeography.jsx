...
const mockQuestions = [
  {
    id: 1,
    country: "Croatia",
    question: "Which river flows through the Croatian capital, Zagreb?",
    options: ["Danube", "Sava", "Drava", "Neretva"],
    correctAnswer: 1,
    difficulty: "Medium",
  },
  {
    id: 2,
    country: "Netherlands",
    question: "What is the largest province of the Netherlands by land area?",
    options: ["Friesland", "Zeeland", "North Brabant", "Gelderland"],
    correctAnswer: 3,
    difficulty: "Medium",
  },
  {
    id: 3,
    country: "Croatia",
    question: "The Croatian city of Rijeka lies on which body of water?",
    options: ["Bay of Piran", "Split Bay", "Kvarner Bay", "Gulf of Trieste"],
    correctAnswer: 2,
    difficulty: "Medium",
  },
  {
    id: 4,
    country: "Netherlands",
    question: "Which Dutch city is home to the headquarters of the International Court of Justice?",
    options: ["Utrecht", "The Hague", "Amsterdam", "Rotterdam"],
    correctAnswer: 1,
    difficulty: "Medium",
  },
  {
    id: 5,
    country: "Croatia",
    question: "Which mountain is the highest peak in Croatia?",
    options: ["Dinara", "Medvednica", "Velebit", "Biokovo"],
    correctAnswer: 0,
    difficulty: "Medium",
  },
  {
    id: 6,
    country: "Netherlands",
    question: "The IJsselmeer is a large lake in the Netherlands. What was it before it became a lake?",
    options: ["A sea inlet", "A glacier basin", "A swamp", "A river"],
    correctAnswer: 0,
    difficulty: "Medium",
  },
  {
    id: 7,
    country: "Croatia",
    question: "Which island is the largest in Croatia by area?",
    options: ["Korčula", "Hvar", "Cres", "Brač"],
    correctAnswer: 2,
    difficulty: "Medium",
  },
  {
    id: 8,
    country: "Netherlands",
    question: "Which province is known for its many tulip fields around the city of Lisse and the Keukenhof Gardens?",
    options: ["Overijssel", "South Holland", "Limburg", "Utrecht"],
    correctAnswer: 1,
    difficulty: "Medium",
  },
  {
    id: 9,
    country: "Croatia",
    question: "Croatia shares the Danube River border with which country?",
    options: ["Slovenia", "Italy", "Montenegro", "Hungary"],
    correctAnswer: 3,
    difficulty: "Medium",
  },
  {
    id: 10,
    country: "Netherlands",
    question: "Which is the busiest airport in the Netherlands?",
    options: ["Eindhoven Airport", "Maastricht Aachen Airport", "Amsterdam Schiphol", "Rotterdam The Hague Airport"],
    correctAnswer: 2,
    difficulty: "Medium",
  }
]

export default function MediumGeography() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center">
        <div className="text-center text-white">
          ...
          <p className="text-xl font-bold">Get ready for a geographical challenge! ⚡</p>
        </div>
      </div>
    )
  }
              ...
              <div className="text-center space-y-4">
                <p className="text-gray-700 text-lg font-medium bg-white/50 p-4 rounded-xl border border-gray-200">
                  {score >= 120
                    ...
                    : score >= 90
                      ? "👍 Excellent work! You know these geographical features inside out!"
                      : score >= 60
                        ? "💪 Good job! Solid knowledge of Croatian and Dutch geography!"
